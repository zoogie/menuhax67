#define IFile_Open 0x0022bc6c+4
#define IFile_Read 0x0022bb58+4
...
#define POP_R0127PC 0x0017209c+1 //: pop {r0, r1, r2, r7, pc}
#define POP_R012347PC 0x001eac92+1 //: pop {r0, r1, r2, r3, r4, r7, pc}
#define ROP_POPPC 0x0010e5d8
#define POP_R0PC 0x00157920
#define POP_R1PC 0x002371dc

#define BASE 0x00346a10 
#define MNT 0x00321a76   // YS:
#define PATH 0x0023a822  // YS:/Launcher.dat
